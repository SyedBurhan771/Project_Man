...
# Globals 
DIR_BACKEND           = os.path.abspath(os.path.join(os.path.dirname(__file__), '..'))
DIR_ROOT              = os.path.abspath(os.path.join(DIR_BACKEND, '..'))
DIR_FRONTEND          = os.path.join(DIR_ROOT, 'frontend')
DIR_DEPLOYMENT        = os.path.join(DIR_ROOT, 'deployment')
DIR_TMPL              = os.path.join(DIR_FRONTEND, 'templates')
DIR_STATIC            = os.path.join(DIR_FRONTEND, 'static')

DIR_DJ_CONFIG         = 'config'
DIR_DJ_APP_DEFAULT    = 'home'

FILE_DJ_MANAGE_s      = os.path.join('backend', 'manage.py')
FILE_DJ_ENV_s         = os.path.join('backend', '.env')
FILE_DJ_DEPS_s        = os.path.join('backend', 'requirements.txt')
FILE_DJ_URLS_s        = os.path.join('backend', DIR_DJ_CONFIG      , 'urls.py'     )
FILE_DJ_SETTINGS_s    = os.path.join('backend', DIR_DJ_CONFIG      , 'settings.py' )
FILE_DJ_INIT_s        = os.path.join('backend', DIR_DJ_CONFIG      , '__init__.py' )
FILE_DJ_MODELS_s      = os.path.join('backend', DIR_DJ_APP_DEFAULT , 'models.py'   )

FILE_CI_BUILD_s       = os.path.join('deployment', 'build.sh')
FILE_CI_RENDER_s      = os.path.join('deployment', 'render.yaml')
FILE_DOCKER_s         = os.path.join('deployment', 'Dockerfile')
